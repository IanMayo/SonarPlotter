...
axes.prototype.willDrawChart = function(e) {
  ...
  if (g.getOptionForAxis('drawAxis', 'x')) {
    ...
    //console.log(axisY);
    //console.log(halfUp(area.x + area.w));
    context.moveTo(halfUp(area.x), axisY);
    context.lineTo(halfUp(area.x + area.w), axisY);
    context.moveTo(halfUp(area.x + area.w)-1, axisY);
    context.lineTo(halfUp(area.x + area.w)-1, context.lineWidth);
    context.moveTo(halfUp(area.x + area.w)-1, context.lineWidth);
    context.lineTo(halfUp(area.x), context.lineWidth);
    context.closePath();
